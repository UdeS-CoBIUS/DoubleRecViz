...
def doubleReconciliation(dictTrans, dictTransInv, dictGene, dictGeneInv, dictSpecies, dictSpeciesInv,transcrit_tree, transcrit_tree_label, gene_tree_newname_label, gene_tree, gene_tree_newname, speciesTree, species_tree_new_name):
...
def main():
	...
	doubleReconciliation(dictTrans, dictTransInv, dictGene, dictGeneInv, dictSpecies, dictSpeciesInv,transcrit_tree, transcrit_tree_label, gene_tree_newname_label, gene_tree, gene_tree_newname, speciesTree, species_tree_new_name)
