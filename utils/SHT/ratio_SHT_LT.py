...
def main_corrected_ensemblTree(all=0):	
	...
	for x in glob.glob("clusters_100_0/fuzzyCMeans/*_cluster_1_root.nhx"): 		
	    try:
		    ...
		    cds_files_used_by_LT = "/home/local/USHERBROOKE/kuie2201/Bureau/MarieDegen/SpliceGraph/ensemblGeneTree/transcript_protein_gene/"+ x +"_update.txt"
		    file = open(cds_files_used_by_LT, "r")
		    LT_CDS = []
		    LT_CDS_dict = {}
		    genes_used_by_LT = []
		    ...
		    for line in lines:
			    ...
			    line = line.split("\t")
			    if len(line) == 4:
				    if line[1] in SHT_CDS_dict.keys():
					    LT_CDS.append(line[3])
					    genes_used_by_LT.append(line[1])
