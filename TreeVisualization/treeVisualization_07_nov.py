...
def get_x_coordinates_new(tree):
...
def create_tree(tree_file):
    ...
    y_coords_new = get_y_coordinates_new(tree, 5, 1.3)
    ...
    line_shapes = []
    draw_clade(tree.root, 0, line_shapes, line_color=random_color(), line_width=3, x_coords=x_coords,
               y_coords=y_coords)
